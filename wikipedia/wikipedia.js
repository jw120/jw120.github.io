...
//
var apiPrefix = "http://en.wikipedia.org/w/api.php?action=opensearch&namespace=0&format=json&search=";
...
function updateSearchList(result) {
    ...
    result.titles.forEach(function (title, i) {
...
function validateResult(raw) {
    if (Array.isArray(raw) &&
        ...
        typeof raw[0] === "string" &&
        Array.isArray(raw[1]) &&
        raw[1].every(function (x) { return typeof x === "string"; }) &&
        Array.isArray(raw[2]) &&
        raw[2].every(function (x) { return typeof x === "string"; }) &&
        Array.isArray(raw[3]) &&
        raw[3].every(function (x) { return typeof x === "string"; }) &&
