...
Elm.Maths = Elm.Maths || {};
Elm.Maths.make = function (_elm) {
   "use strict";
   _elm.Maths = _elm.Maths || {};
   if (_elm.Maths.values) return _elm.Maths.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var applyOp = F3(function (op,x,y) {
      var _p0 = op;
      switch (_p0.ctor)
      {case "Add": return x + y;
   ...
   var toFractional = function (x) {
      var go = function (x) {    go: while (true) if (_U.cmp($Basics.abs(x),1) > 0) {    var _v1 = x / 10;x = _v1;continue go;} else return x;};
      return go($Basics.toFloat(x));
   };
   var evalDigit = function (d) {
      var _p1 = d;
      switch (_p1.ctor)
      {case "One": return 1;
         case "Two": return 2;
   ...
   var Add = {ctor: "Add"};
   return _elm.Maths.values = {_op: _op
                              ,Add: Add
                              ,Subtract: Subtract
                              ,Multiply: Multiply
                              ,Divide: Divide
...
Elm.Actions.make = function (_elm) {
   ...
   var ClearEntry = {ctor: "ClearEntry"};
   var AllClear = {ctor: "AllClear"};
   var Percent = {ctor: "Percent"};
   var Equals = {ctor: "Equals"};
   var Point = {ctor: "Point"};
   var BinOpEntry = function (a) {    return {ctor: "BinOpEntry",_0: a};};
   var DigitEntry = function (a) {    return {ctor: "DigitEntry",_0: a};};
   var NoOp = {ctor: "NoOp"};
   return _elm.Actions.values = {_op: _op
                                ,NoOp: NoOp
                                ,DigitEntry: DigitEntry
                                ,BinOpEntry: BinOpEntry
                                ,Point: Point
                                ,Equals: Equals
                                ,Percent: Percent
                                ,AllClear: AllClear
...
Elm.Models.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var evalEntry = function (entry) {
      var _p0 = entry;
      switch (_p0.ctor)
      {case "Empty": return 0;
         case "Integer": return $Basics.toFloat(_p0._0);
         case "Decimal": return $Basics.toFloat(_p0._0._0) + $Maths.toFractional(_p0._0._1);
         default: return _p0._0;}
   };
   var Result = function (a) {    return {ctor: "Result",_0: a};};
   var Decimal = function (a) {    return {ctor: "Decimal",_0: a};};
   var Integer = function (a) {    return {ctor: "Integer",_0: a};};
   var Empty = {ctor: "Empty"};
   var negate = function (entry) {
      var _p1 = entry;
      switch (_p1.ctor)
      {case "Empty": return Empty;
         case "Integer": return Integer(0 - _p1._0);
         case "Decimal": return Decimal({ctor: "_Tuple2",_0: 0 - _p1._0._0,_1: _p1._0._1});
         default: return Result(0 - _p1._0);}
   };
   var showAppModel = function (model) {
      return A2($Basics._op["++"],
      "entry = ",
      A2($Basics._op["++"],
      $Basics.toString(model.entry),
      A2($Basics._op["++"],", value = ",A2($Basics._op["++"],$Basics.toString(model.value),A2($Basics._op["++"],", op = ",$Basics.toString(model.op))))));
   };
   var initialModel = {entry: Empty,op: $Maybe.Nothing,value: 0,debugMode: false};
   var AppModel = F4(function (a,b,c,d) {    return {entry: a,value: b,op: c,debugMode: d};});
   return _elm.Models.values = {_op: _op
                               ,AppModel: AppModel
                               ,initialModel: initialModel
                               ,showAppModel: showAppModel
                               ,Empty: Empty
                               ,Integer: Integer
                               ,Decimal: Decimal
                               ,Result: Result
...
Elm.Presses = Elm.Presses || {};
Elm.Presses.make = function (_elm) {
   "use strict";
   _elm.Presses = _elm.Presses || {};
   if (_elm.Presses.values) return _elm.Presses.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   var handler = function (key) {
      ...
      switch (_p0.valueOf())
      {case "1": return $Actions.DigitEntry($Maths.One);
         case "2": return $Actions.DigitEntry($Maths.Two);
         case "3": return $Actions.DigitEntry($Maths.Three);
         case "4": return $Actions.DigitEntry($Maths.Four);
         case "5": return $Actions.DigitEntry($Maths.Five);
         case "6": return $Actions.DigitEntry($Maths.Six);
         case "7": return $Actions.DigitEntry($Maths.Seven);
         case "8": return $Actions.DigitEntry($Maths.Eight);
         case "9": return $Actions.DigitEntry($Maths.Nine);
         case "0": return $Actions.DigitEntry($Maths.Zero);
         case "+": return $Actions.BinOpEntry($Maths.Add);
         case "-": return $Actions.BinOpEntry($Maths.Subtract);
         case "*": return $Actions.BinOpEntry($Maths.Multiply);
         case "/": return $Actions.BinOpEntry($Maths.Divide);
         case "%": return $Actions.Percent;
         case ".": return $Actions.Point;
         case "=": return $Actions.Equals;
         case "d": return $Actions.ToggleDebug;
         case "D": return $Actions.ToggleDebug;
         default: return $Actions.NoOp;}
   };
   return _elm.Presses.values = {_op: _op,handler: handler};
};
...
Elm.Update.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      {case "NoOp": return model;
         case "DigitEntry": var _p2 = _p0._0;
           var _p1 = model.entry;
           switch (_p1.ctor)
           {case "Empty": return _U.update(model,{entry: $Models.Integer($Maths.evalDigit(_p2))});
              case "Integer": return _U.update(model,{entry: $Models.Integer(_p1._0 * 10 + $Maths.evalDigit(_p2))});
              case "Decimal": return _U.update(model,{entry: $Models.Decimal({ctor: "_Tuple2",_0: _p1._0._0,_1: _p1._0._1 * 10 + $Maths.evalDigit(_p2)})});
              default: return _U.update(model,{entry: $Models.Integer($Maths.evalDigit(_p2))});}
         case "Point": var _p3 = model.entry;
           switch (_p3.ctor)
           {case "Empty": return _U.update(model,{entry: $Models.Decimal({ctor: "_Tuple2",_0: 0,_1: 0})});
              case "Integer": return _U.update(model,{entry: $Models.Decimal({ctor: "_Tuple2",_0: _p3._0,_1: 0})});
              case "Decimal": return model;
              default: return _U.update(model,{entry: $Models.Decimal({ctor: "_Tuple2",_0: 0,_1: 0})});}
         case "BinOpEntry": return _U.update(model,{entry: $Models.Empty,value: $Models.evalEntry(model.entry),op: $Maybe.Just(_p0._0)});
         case "Equals": var _p4 = model.op;
           if (_p4.ctor === "Nothing") {
                 return model;
              } else {
                 var answer = A3($Maths.applyOp,_p4._0,model.value,$Models.evalEntry(model.entry));
                 return _U.update(model,{entry: $Models.Result(answer),value: answer,op: $Maybe.Nothing});
              }
         case "Percent": var _p5 = model.op;
           if (_p5.ctor === "Nothing") {
                 return _U.update(model,{entry: $Models.Result($Models.evalEntry(model.entry) / 100)});
              } else {
                 return _U.update(model,{entry: $Models.Result(A3($Maths.applyOp,$Maths.Multiply,model.value,$Models.evalEntry(model.entry)) / 100)});
              }
         case "AllClear": return _U.update(model,{entry: $Models.Empty,value: 0,op: $Maybe.Nothing});
         case "ClearEntry": return _U.update(model,{entry: $Models.Empty});
         case "PlusMinus": return _U.update(model,{entry: $Models.negate(model.entry)});
         default: return _U.update(model,{debugMode: $Basics.not(model.debugMode)});}
   });
...
Elm.View.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var calcButton = F4(function (address,action,label,extraAttributes) {
      return A2($Html.div,
      A2($List._op["::"],$Html$Attributes.$class("calc-button"),A2($List._op["::"],A2($Html$Events.onClick,address,action),extraAttributes)),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("calc-button-label")]),_U.list([$Html.text(label)]))]));
   });
   var calcButtonRow = F5(function (address,_p3,_p2,_p1,_p0) {
      var _p4 = _p3;
      var _p5 = _p2;
      var _p6 = _p1;
      var _p7 = _p0;
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("calc-button-row")]),
      _U.list([A4(calcButton,address,_p4._1,_p4._0,_p4._2)
              ,A4(calcButton,address,_p5._1,_p5._0,_p5._2)
              ,A4(calcButton,address,_p6._1,_p6._0,_p6._2)
              ,A4(calcButton,address,_p7._1,_p7._0,_p7._2)]));
   });
   var calcDisplay = function (model) {
      var displayText = function () {
         var _p8 = model.entry;
         if (_p8.ctor === "Empty") {
               return $Html.text($Basics.toString(model.value));
            } else {
               return $Html.text($Basics.toString($Models.evalEntry(_p8)));
            }
      }();
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("calc-display")]),
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("calc-display-text")]),_U.list([displayText]))]));
   };
   var debugBox = function (model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("calc-debug-box")]),_U.list([$Html.text(model.debugMode ? $Models.showAppModel(model) : "")]));
   };
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("calc")]),
      _U.list([calcDisplay(model)
              ,A5(calcButtonRow,
              address,
              {ctor: "_Tuple3",_0: "AC",_1: $Actions.AllClear,_2: _U.list([$Html$Attributes.$class("calc-button-clear")])},
              {ctor: "_Tuple3",_0: "CE",_1: $Actions.ClearEntry,_2: _U.list([$Html$Attributes.$class("calc-button-clear")])},
              {ctor: "_Tuple3",_0: "%",_1: $Actions.Percent,_2: _U.list([])},
              {ctor: "_Tuple3",_0: "/",_1: $Actions.BinOpEntry($Maths.Divide),_2: _U.list([])})
              ,A5(calcButtonRow,
              address,
              {ctor: "_Tuple3",_0: "7",_1: $Actions.DigitEntry($Maths.Seven),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "8",_1: $Actions.DigitEntry($Maths.Eight),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "9",_1: $Actions.DigitEntry($Maths.Nine),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "*",_1: $Actions.BinOpEntry($Maths.Multiply),_2: _U.list([])})
              ,A5(calcButtonRow,
              address,
              {ctor: "_Tuple3",_0: "4",_1: $Actions.DigitEntry($Maths.Four),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "5",_1: $Actions.DigitEntry($Maths.Five),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "6",_1: $Actions.DigitEntry($Maths.Six),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "-",_1: $Actions.BinOpEntry($Maths.Subtract),_2: _U.list([])})
              ,A5(calcButtonRow,
              address,
              {ctor: "_Tuple3",_0: "1",_1: $Actions.DigitEntry($Maths.One),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "2",_1: $Actions.DigitEntry($Maths.Two),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "3",_1: $Actions.DigitEntry($Maths.Three),_2: _U.list([])},
              {ctor: "_Tuple3",_0: "+",_1: $Actions.BinOpEntry($Maths.Add),_2: _U.list([])})
              ,A5(calcButtonRow,
              address,
              {ctor: "_Tuple3",_0: "0",_1: $Actions.DigitEntry($Maths.Zero),_2: _U.list([])},
              {ctor: "_Tuple3",_0: ".",_1: $Actions.Point,_2: _U.list([])},
              {ctor: "_Tuple3",_0: "=",_1: $Actions.Equals,_2: _U.list([])},
              {ctor: "_Tuple3",_0: "PM",_1: $Actions.PlusMinus,_2: _U.list([])})
              ,debugBox(model)]));
   });
   return _elm.View.values = {_op: _op,view: view,debugBox: debugBox,calcDisplay: calcDisplay,calcButtonRow: calcButtonRow,calcButton: calcButton};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: $Models.initialModel,_1: $Effects.none}
                             ,inputs: _U.list([A2($Signal.map,$Presses.handler,$Keyboard.presses)])
                             ,update: F2(function (a,m) {    return {ctor: "_Tuple2",_0: A2($Update.update,a,m),_1: $Effects.none};})
                             ,view: $View.view});
   var main = app.html;
