...
Elm.List = Elm.List || {};
Elm.List.Nonempty = Elm.List.Nonempty || {};
Elm.List.Nonempty.make = function (_elm) {
   "use strict";
   _elm.List = _elm.List || {};
   _elm.List.Nonempty = _elm.List.Nonempty || {};
   if (_elm.List.Nonempty.values) return _elm.List.Nonempty.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var foldl1 = F2(function (f,_p0) {    var _p1 = _p0;return A3($List.foldl,f,_p1._0,_p1._1);});
   var foldl = F3(function (f,b,_p2) {    var _p3 = _p2;return A3($List.foldl,f,b,A2($List._op["::"],_p3._0,_p3._1));});
   var any = F2(function (f,_p4) {    var _p5 = _p4;return f(_p5._0) || A2($List.any,f,_p5._1);});
   var all = F2(function (f,_p6) {    var _p7 = _p6;return f(_p7._0) && A2($List.all,f,_p7._1);});
   var member = F2(function (y,_p8) {    var _p9 = _p8;return _U.eq(_p9._0,y) || A2($List.member,y,_p9._1);});
   var length = function (_p10) {    var _p11 = _p10;return $List.length(_p11._1) + 1;};
   var isSingleton = function (_p12) {    var _p13 = _p12;return $List.isEmpty(_p13._1);};
   var get = F2(function (i,_p14) {
      var _p15 = _p14;
      var find = F2(function (k,ys) {
         find: while (true) {
            var _p16 = ys;
            if (_p16.ctor === "[]") {
                  return _U.crashCase("List.Nonempty",
                  {start: {line: 104,column: 7},end: {line: 112,column: 28}},
                  _p16)("This can\'t happen: attempted to take value at safe index from empty list");
               } else {
                  if (_U.eq(k,0)) return _p16._0; else {
                        var _v9 = k - 1,_v10 = _p16._1;
                        k = _v9;
                        ys = _v10;
                        continue find;
                     }
      ...
      var j = A2($Basics._op["%"],i,length(_p15));
      return _U.eq(j,0) ? _p15._0 : A2(find,j - 1,_p15._1);
   });
   var sample = function (nonempty) {    return A2($Random.map,function (i) {    return A2(get,i,nonempty);},A2($Random.$int,0,length(nonempty) - 1));};
   var toList = function (_p18) {    var _p19 = _p18;return A2($List._op["::"],_p19._0,_p19._1);};
   var tail = function (_p20) {    var _p21 = _p20;return _p21._1;};
   var head = function (_p22) {    var _p23 = _p22;return _p23._0;};
   var Nonempty = F2(function (a,b) {    return {ctor: "Nonempty",_0: a,_1: b};});
   var fromElement = function (x) {    return A2(Nonempty,x,_U.list([]));};
   var fromList = function (ys) {
      var _p24 = ys;
      if (_p24.ctor === "::") {
            return $Maybe.Just(A2(Nonempty,_p24._0,_p24._1));
         } else {
            return $Maybe.Nothing;
         }
   };
   var cons = F2(function (y,_p25) {    var _p26 = _p25;return A2(Nonempty,y,A2($List._op["::"],_p26._0,_p26._1));});
   _op[":::"] = cons;
   var append = F2(function (_p28,_p27) {
      var _p29 = _p28;
      var _p30 = _p27;
      return A2(Nonempty,_p29._0,A2($Basics._op["++"],_p29._1,A2($List._op["::"],_p30._0,_p30._1)));
   });
   var pop = function (_p31) {
      var _p32 = _p31;
      var _p34 = _p32._1;
      var _p33 = _p34;
      if (_p33.ctor === "[]") {
            return A2(Nonempty,_p32._0,_p34);
         } else {
            return A2(Nonempty,_p33._0,_p33._1);
         }
   };
   var reverse = function (_p35) {
      var _p36 = _p35;
      var revapp = function (_p37) {
         revapp: while (true) {
            ...
            var _p39 = _p38._2;
            if (_p39.ctor === "[]") {
                  return A2(Nonempty,_p40,_p41);
               } else {
                  var _v23 = {ctor: "_Tuple3",_0: A2($List._op["::"],_p40,_p41),_1: _p39._0,_2: _p39._1};
                  _p37 = _v23;
                  continue revapp;
               }
         }
      };
      return revapp({ctor: "_Tuple3",_0: _U.list([]),_1: _p36._0,_2: _p36._1});
   };
   var concat = function (_p42) {
      var _p43 = _p42;
      var _p44 = _p43._0;
      var tl = A2($Basics._op["++"],tail(_p44),$List.concat(A2($List.map,toList,_p43._1)));
      var hd = head(_p44);
      return A2(Nonempty,hd,tl);
   };
   var replaceHead = F2(function (y,_p45) {    var _p46 = _p45;return A2(Nonempty,y,_p46._1);});
   var replaceTail = F2(function (ys,_p47) {    var _p48 = _p47;return A2(Nonempty,_p48._0,ys);});
   var dropTail = function (_p49) {    var _p50 = _p49;return A2(Nonempty,_p50._0,_U.list([]));};
   var map = F2(function (f,_p51) {    var _p52 = _p51;return A2(Nonempty,f(_p52._0),A2($List.map,f,_p52._1));});
   var concatMap = F2(function (f,xs) {    return concat(A2(map,f,xs));});
   var map2 = F3(function (f,_p54,_p53) {    var _p55 = _p54;var _p56 = _p53;return A2(Nonempty,A2(f,_p55._0,_p56._0),A3($List.map2,f,_p55._1,_p56._1));});
   var andMap = map2(F2(function (x,y) {    return x(y);}));
   var indexedMap = F2(function (f,_p57) {
      var _p58 = _p57;
      var wrapped = F2(function (i,d) {    return A2(f,i + 1,d);});
      return A2(Nonempty,A2(f,0,_p58._0),A2($List.indexedMap,wrapped,_p58._1));
   });
   var filter = F3(function (p,d,_p59) {
      var _p60 = _p59;
      var _p63 = _p60._1;
      var _p62 = _p60._0;
      if (p(_p62)) return A2(Nonempty,_p62,A2($List.filter,p,_p63)); else {
            var _p61 = A2($List.filter,p,_p63);
            if (_p61.ctor === "[]") {
                  return A2(Nonempty,d,_U.list([]));
               } else {
                  return A2(Nonempty,_p61._0,_p61._1);
               }
         }
   });
   var sort = function (_p64) {
      var _p65 = _p64;
      var _p66 = $List.sort(A2($List._op["::"],_p65._0,_p65._1));
      if (_p66.ctor === "::") {
            return A2(Nonempty,_p66._0,_p66._1);
         } else {
            return _U.crashCase("List.Nonempty",
            {start: {line: 329,column: 3},end: {line: 334,column: 86}},
            _p66)("This can\'t happen: sorting a nonempty list returned an empty list");
         }
   };
   var sortBy = F2(function (f,_p68) {
      var _p69 = _p68;
      var _p70 = A2($List.sortBy,f,A2($List._op["::"],_p69._0,_p69._1));
      if (_p70.ctor === "::") {
            return A2(Nonempty,_p70._0,_p70._1);
         } else {
            return _U.crashCase("List.Nonempty",
            {start: {line: 341,column: 3},end: {line: 346,column: 88}},
            _p70)("This can\'t happen: sortBying a nonempty list returned an empty list");
         }
   });
   var sortWith = F2(function (f,_p72) {
      var _p73 = _p72;
      var _p74 = A2($List.sortWith,f,A2($List._op["::"],_p73._0,_p73._1));
      if (_p74.ctor === "::") {
            return A2(Nonempty,_p74._0,_p74._1);
         } else {
            return _U.crashCase("List.Nonempty",
            {start: {line: 353,column: 3},end: {line: 358,column: 90}},
            _p74)("This can\'t happen: sortWithing a nonempty list returned an empty list");
         }
   });
   var dedup = function (_p76) {
      var _p77 = _p76;
      var dedupe = F3(function (prev,done,next) {
         dedupe: while (true) {
            var _p78 = next;
            if (_p78.ctor === "[]") {
                  return A2(Nonempty,prev,done);
               } else {
                  var _p80 = _p78._1;
                  var _p79 = _p78._0;
                  if (_U.eq(_p79,prev)) {
                        var _v42 = prev,_v43 = done,_v44 = _p80;
                        prev = _v42;
                        done = _v43;
                        next = _v44;
                        continue dedupe;
                     } else {
                        var _v45 = _p79,_v46 = A2($List._op["::"],prev,done),_v47 = _p80;
                        prev = _v45;
                        done = _v46;
                        next = _v47;
                        continue dedupe;
      ...
      return reverse(A3(dedupe,_p77._0,_U.list([]),_p77._1));
   };
   var uniq = function (_p81) {
      var _p82 = _p81;
      var _p86 = _p82._0;
      var unique = F3(function (seen,done,next) {
         unique: while (true) {
            var _p83 = next;
            if (_p83.ctor === "[]") {
                  return done;
                  ...
                  var _p85 = _p83._1;
                  var _p84 = _p83._0;
                  if (A2($List.member,_p84,seen)) {
                        var _v50 = seen,_v51 = done,_v52 = _p85;
                        seen = _v50;
                        done = _v51;
                        next = _v52;
                        continue unique;
                     } else {
                        var _v53 = A2($List._op["::"],_p84,seen),_v54 = A2(_op[":::"],_p84,done),_v55 = _p85;
                        seen = _v53;
                        done = _v54;
                        next = _v55;
                        continue unique;
      ...
      return reverse(A3(unique,_U.list([_p86]),A2(Nonempty,_p86,_U.list([])),_p82._1));
   };
   var scanl = F3(function (f,b,_p87) {    var _p88 = _p87;return A2(Nonempty,b,A3($List.scanl,f,A2(f,_p88._0,b),_p88._1));});
   var scanl1 = F2(function (f,_p89) {
      var _p90 = _p89;
      var _p92 = _p90._0;
      var _p91 = _p90._1;
      if (_p91.ctor === "[]") {
            return A2(Nonempty,_p92,_U.list([]));
         } else {
            return A2(Nonempty,_p92,A3($List.scanl,f,A2(f,_p91._0,_p92),_p91._1));
         }
   });
   return _elm.List.Nonempty.values = {_op: _op
                                      ,Nonempty: Nonempty
                                      ,fromElement: fromElement
                                      ,fromList: fromList
                                      ,head: head
...
Elm.BoardConstants = Elm.BoardConstants || {};
Elm.BoardConstants.make = function (_elm) {
   "use strict";
   _elm.BoardConstants = _elm.BoardConstants || {};
   if (_elm.BoardConstants.values) return _elm.BoardConstants.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var boardLines = _U.list([{ctor: "_Tuple3",_0: 1,_1: 2,_2: 3}
                            ,{ctor: "_Tuple3",_0: 4,_1: 5,_2: 6}
                            ,{ctor: "_Tuple3",_0: 7,_1: 8,_2: 9}
                            ,{ctor: "_Tuple3",_0: 1,_1: 4,_2: 7}
                            ,{ctor: "_Tuple3",_0: 2,_1: 5,_2: 8}
                            ,{ctor: "_Tuple3",_0: 3,_1: 6,_2: 9}
                            ,{ctor: "_Tuple3",_0: 1,_1: 5,_2: 9}
                            ,{ctor: "_Tuple3",_0: 3,_1: 5,_2: 7}]);
   return _elm.BoardConstants.values = {_op: _op,boardLines: boardLines};
};
Elm.Board = Elm.Board || {};
Elm.Board.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $BoardConstants = Elm.BoardConstants.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var isPiece = F3(function (square,piece,board) {    return _U.eq(A2($Dict.get,square,board),$Maybe.Just(piece));});
   var addPiece = $Dict.insert;
   var isEmptySquare = F2(function (square,board) {    return _U.eq(A2($Dict.get,square,board),$Maybe.Nothing);});
   var emptySquares = function (board) {    return A2($List.filter,function (s) {    return A2(isEmptySquare,s,board);},_U.range(1,9));};
   var isFull = function (board) {    return $Basics.not(A2($List.any,function (s) {    return A2(isEmptySquare,s,board);},_U.range(1,9)));};
   var getPiece = $Dict.get;
   var isLine = F2(function (_p0,b) {
      var _p1 = _p0;
      var p3 = A2(getPiece,_p1._2,b);
      var p2 = A2(getPiece,_p1._1,b);
      var p1 = A2(getPiece,_p1._0,b);
      return _U.eq(p1,p2) && _U.eq(p2,p3) ? p1 : $Maybe.Nothing;
   });
   var hasLine = function (board) {
      var isLine$ = function (l) {    return A2($Maybe.map,function (p) {    return {ctor: "_Tuple2",_0: p,_1: l};},A2(isLine,l,board));};
      return $List.head(A2($List.filterMap,isLine$,$BoardConstants.boardLines));
   };
   var isValid = function (_p2) {    return $Dict.isEmpty(A2($Dict.filter,F2(function (k,_p3) {    return _U.cmp(k,1) < 0 || _U.cmp(k,9) > 0;}),_p2));};
   var isEmpty = $Dict.isEmpty;
   var emptyBoard = $Dict.empty;
   var toList = $Dict.toList;
   var pieceCount = function (player) {
      return function (_p4) {
         return $List.length(A2($List.filter,function (_p5) {    var _p6 = _p5;return _U.eq(_p6._1,player);},toList(_p4)));
      };
   };
   var fromList = $Dict.fromList;
   var O = {ctor: "O"};
   var X = {ctor: "X"};
   var opposite = function (p) {    var _p7 = p;if (_p7.ctor === "X") {    return O;} else {    return X;}};
...
Elm.Actions.make = function (_elm) {
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var StartingTick = function (a) {    return {ctor: "StartingTick",_0: a};};
   var ToggleDebug = {ctor: "ToggleDebug"};
   var ComputerMoved = function (a) {    return {ctor: "ComputerMoved",_0: a};};
   var PlayerMoved = function (a) {    return {ctor: "PlayerMoved",_0: a};};
   var StartAsMaru = {ctor: "StartAsMaru"};
   var StartAsBatsu = {ctor: "StartAsBatsu"};
   var NoOp = {ctor: "NoOp"};
   return _elm.Actions.values = {_op: _op
                                ,NoOp: NoOp
                                ,StartAsBatsu: StartAsBatsu
                                ,StartAsMaru: StartAsMaru
                                ,PlayerMoved: PlayerMoved
                                ,ComputerMoved: ComputerMoved
                                ,ToggleDebug: ToggleDebug
                                ,StartingTick: StartingTick};
};
Elm.RandomChoice = Elm.RandomChoice || {};
Elm.RandomChoice.make = function (_elm) {
   "use strict";
   _elm.RandomChoice = _elm.RandomChoice || {};
   if (_elm.RandomChoice.values) return _elm.RandomChoice.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $List$Nonempty = Elm.List.Nonempty.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Random = Elm.Random.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var fromList = F2(function (seed,xs) {
      var gen = A2($Random.$int,0,$List$Nonempty.length(xs) - 1);
      var _p0 = A2($Random.generate,gen,seed);
      var i = _p0._0;
      var seed$ = _p0._1;
      return {ctor: "_Tuple2",_0: seed$,_1: A2($List$Nonempty.get,i,xs)};
   });
   return _elm.RandomChoice.values = {_op: _op,fromList: fromList};
};
Elm.Computer = Elm.Computer || {};
Elm.Computer.make = function (_elm) {
   "use strict";
   _elm.Computer = _elm.Computer || {};
   if (_elm.Computer.values) return _elm.Computer.values;
   var _U = Elm.Native.Utils.make(_elm),
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Random = Elm.Random.make(_elm),
   $RandomChoice = Elm.RandomChoice.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var availableMoves = F2(function (board,piece) {
      return A2($List.map,
      function (square) {
         return {ctor: "_Tuple3",_0: piece,_1: square,_2: A3($Board.addPiece,square,piece,board)};
      },
      $Board.emptySquares(board));
   });
   var bestScoredMove = F2(function (player,board) {
      var optimizeForPlayer = function (_p0) {    return A2($Maybe.withDefault,0,(_U.eq(player,$Board.X) ? $List.maximum : $List.minimum)(_p0));};
      var moves = A2(availableMoves,board,player);
      var scoredMoves = A2($List.map,addScore,moves);
      var bestScore = optimizeForPlayer(A2($List.map,$Basics.snd,scoredMoves));
      var bestScoredMoves = A2($List.filter,function (_p1) {    var _p2 = _p1;return _U.eq(_p2._1,bestScore);},scoredMoves);
      return $List.head(bestScoredMoves);
   });
   var addScore = function (_p3) {
      var _p4 = _p3;
      var _p7 = _p4._1;
      var _p6 = _p4._0;
      var _p5 = _p4._2;
      return {ctor: "_Tuple2",_0: {ctor: "_Tuple3",_0: _p6,_1: _p7,_2: _p5},_1: A2(score,A3($Board.addPiece,_p7,_p6,_p5),$Board.opposite(_p6))};
   };
   var score = F2(function (board,player) {
      var _p8 = $Board.hasLine(board);
      if (_p8.ctor === "Just") {
            var _p9 = _p8._0._0;
            return (100 - A2($Board.pieceCount,_p9,board)) * (_U.eq(_p9,$Board.X) ? 1 : -1);
         } else {
            return $Board.isFull(board) ? 0 : A2($Maybe.withDefault,0,A2($Maybe.map,$Basics.snd,A2(bestScoredMove,player,board)));
         }
   });
   var heuristicOne = F4(function (seed,occupied,board,player) {
      var _p10 = _U.eq(occupied,5) ? A2($RandomChoice.fromList,seed,A2($List$Nonempty.Nonempty,1,_U.list([3,7,9]))) : {ctor: "_Tuple2",_0: seed,_1: 5};
      var seed$ = _p10._0;
      var response = _p10._1;
      return {ctor: "_Tuple2",_0: seed$,_1: $Maybe.Just({ctor: "_Tuple3",_0: player,_1: response,_2: A3($Board.addPiece,response,player,board)})};
   });
   var heuristicEmpty = F3(function (seed,board,player) {
      var _p11 = A2($RandomChoice.fromList,seed,A2($List$Nonempty.Nonempty,1,_U.list([3,7,9])));
      var seed$ = _p11._0;
      var response = _p11._1;
      return {ctor: "_Tuple2",_0: seed$,_1: $Maybe.Just({ctor: "_Tuple3",_0: player,_1: response,_2: A3($Board.addPiece,response,player,board)})};
   });
   var move = F3(function (seed,board,player) {
      var _p12 = $Board.toList(board);
      if (_p12.ctor === "[]") {
            return A3(heuristicEmpty,seed,board,player);
         } else {
            if (_p12._0.ctor === "_Tuple2" && _p12._1.ctor === "[]") {
                  return A4(heuristicOne,seed,_p12._0._0,board,player);
               } else {
                  return function (m) {
                     return {ctor: "_Tuple2",_0: seed,_1: m};
                  }(A2($Maybe.map,$Basics.fst,A2(bestScoredMove,player,board)));
               }
         }
   });
   var moveEffect = F3(function (seed,player,board) {
      var toAction = function (_p13) {
         var _p14 = _p13;
         return function (b) {
            return $Actions.ComputerMoved({ctor: "_Tuple2",_0: _p14._0,_1: b});
         }(A2($Maybe.withDefault,board,A2($Maybe.map,function (_p15) {    var _p16 = _p15;return _p16._2;},_p14._1)));
      };
      return $Effects.task(A2($Task.map,function (_p17) {    var _p18 = _p17;return toAction(A3(move,seed,board,player));},$Task.succeed({ctor: "_Tuple0"})));
   });
   return _elm.Computer.values = {_op: _op,move: move,moveEffect: moveEffect,score: score,availableMoves: availableMoves};
};
...
Elm.KeyPresses.make = function (_elm) {
   ...
   var handler = function (key) {
      var _p0 = $Char.fromCode(key);
      switch (_p0.valueOf())
      {case "d": return $Actions.ToggleDebug;
         case "D": return $Actions.ToggleDebug;
         default: return $Actions.NoOp;}
   };
   return _elm.KeyPresses.values = {_op: _op,handler: handler};
};
...
Elm.Models.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Board = Elm.Board.make(_elm),
   $Computer = Elm.Computer.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var reset = F2(function (player,model) {
      var baseModel = _U.update(model,{board: $Board.emptyBoard,message: "",player: player});
      var _p0 = player;
      if (_p0.ctor === "X") {
            return {ctor: "_Tuple2",_0: baseModel,_1: $Effects.none};
         } else {
            return {ctor: "_Tuple2",_0: baseModel,_1: A3($Computer.moveEffect,model.seed,$Board.X,baseModel.board)};
         }
   });
   var initial = {ctor: "_Tuple2"
                 ,_0: {board: $Board.emptyBoard,player: $Board.X,message: "",debugMode: false,lastAction: $Actions.NoOp,seed: $Random.initialSeed(0)}
                 ,_1: $Effects.tick($Actions.StartingTick)};
   var Model = F6(function (a,b,c,d,e,f) {    return {board: a,player: b,message: c,debugMode: d,seed: e,lastAction: f};});
   return _elm.Models.values = {_op: _op,initial: initial,reset: reset,Model: Model};
};
Elm.ViewConstants = Elm.ViewConstants || {};
Elm.ViewConstants.make = function (_elm) {
   "use strict";
   _elm.ViewConstants = _elm.ViewConstants || {};
   if (_elm.ViewConstants.values) return _elm.ViewConstants.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var batsuLineStyle = _U.update($Graphics$Collage.defaultLine,{color: $Color.blue,width: 10});
   var maruLineStyle = _U.update($Graphics$Collage.defaultLine,{color: $Color.red,width: 10});
   var gridLineStyle = _U.update($Graphics$Collage.defaultLine,{width: 2});
   var batsuFraction = 0.3;
   var maruFraction = 0.3;
   var clickableFraction = 0.8;
   var squareSize = 100.0;
   return _elm.ViewConstants.values = {_op: _op
                                      ,squareSize: squareSize
                                      ,clickableFraction: clickableFraction
                                      ,maruFraction: maruFraction
                                      ,batsuFraction: batsuFraction
                                      ,gridLineStyle: gridLineStyle
                                      ,maruLineStyle: maruLineStyle
                                      ,batsuLineStyle: batsuLineStyle};
};
Elm.MouseClick = Elm.MouseClick || {};
Elm.MouseClick.make = function (_elm) {
   "use strict";
   _elm.MouseClick = _elm.MouseClick || {};
   if (_elm.MouseClick.values) return _elm.MouseClick.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions = Elm.Actions.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $ViewConstants = Elm.ViewConstants.make(_elm);
   var _op = {};
   var decodePosition = function (_p0) {
      var _p1 = _p0;
      var _p3 = _p1._1;
      var _p2 = _p1._0;
      var ySquare = _p3 / $Basics.round($ViewConstants.squareSize) | 0;
      var yOffset = $Basics.abs(($Basics.toFloat(_p3) - $ViewConstants.squareSize * ($Basics.toFloat(ySquare) + 0.5)) / (0.5 * $ViewConstants.squareSize));
      var xSquare = _p2 / $Basics.round($ViewConstants.squareSize) | 0;
      var xOffset = $Basics.abs(($Basics.toFloat(_p2) - $ViewConstants.squareSize * ($Basics.toFloat(xSquare) + 0.5)) / (0.5 * $ViewConstants.squareSize));
      return _U.cmp(xSquare,0) < 0 || (_U.cmp(xSquare,2) > 0 || (_U.cmp(ySquare,0) < 0 || _U.cmp(ySquare,2) > 0)) ? $Actions.NoOp : _U.cmp(xOffset,
      $ViewConstants.clickableFraction) > 0 || _U.cmp(yOffset,
      $ViewConstants.clickableFraction) > 0 ? $Actions.NoOp : $Actions.PlayerMoved(1 + xSquare + 3 * ySquare);
   };
   var signal = A2($Signal.map,decodePosition,A2($Signal.sampleOn,$Mouse.clicks,$Mouse.position));
   return _elm.MouseClick.values = {_op: _op,signal: signal};
};
Elm.Move = Elm.Move || {};
Elm.Move.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getComputerMove = function (model) {
      var computer = $Board.opposite(model.player);
      var _p0 = A3($Computer.move,model.seed,model.board,computer);
      if (_p0._1.ctor === "Just") {
            return $Result.Ok(_U.update(model,{board: _p0._1._0._2,seed: _p0._0}));
         } else {
            return $Result.Err(_U.update(model,{message: "Failed to find a computer move",seed: _p0._0}));
         }
   };
   var checkGameContinues = function (model) {
      var _p1 = $Board.hasLine(model.board);
      if (_p1.ctor === "Just") {
            return $Result.Err(_U.update(model,{message: A2($Basics._op["++"],$Basics.toString(_p1._0._0)," wins!")}));
         } else {
            return $Board.isFull(model.board) ? $Result.Err(_U.update(model,{message: "Drawn"})) : $Result.Ok(model);
         }
   };
   var applyPlayerMove = F2(function (square,model) {
      return A2($Board.isEmptySquare,square,model.board) ? $Result.Ok(_U.update(model,
      {board: A3($Board.addPiece,square,model.player,model.board)})) : $Result.Err(model);
   });
   var computer = F3(function (newSeed,newBoard,model) {
      ...
      }(checkGameContinues(_U.update(model,{board: newBoard,seed: newSeed})));
   });
   var player = F2(function (square,model) {
      return function (result) {
         var _p3 = result;
         if (_p3.ctor === "Ok") {
               var _p4 = _p3._0;
               return {ctor: "_Tuple2",_0: _p4,_1: A3($Computer.moveEffect,model.seed,$Board.opposite(model.player),_p4.board)};
            } else {
               return {ctor: "_Tuple2",_0: _p3._0,_1: $Effects.none};
            }
      }(A3($Basics.flip,$Result.andThen,checkGameContinues,A3($Basics.flip,$Result.andThen,applyPlayerMove(square),checkGameContinues(model))));
   });
   return _elm.Move.values = {_op: _op,player: player,computer: computer};
};
...
Elm.Update.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      var taggedModel = _U.update(model,{lastAction: action});
      var _p0 = action;
      switch (_p0.ctor)
      {case "NoOp": return {ctor: "_Tuple2",_0: taggedModel,_1: $Effects.none};
         case "StartAsBatsu": return A2($Models.reset,$Board.X,taggedModel);
         case "StartAsMaru": return A2($Models.reset,$Board.O,taggedModel);
         case "PlayerMoved": return A2($Move.player,_p0._0,taggedModel);
         case "ComputerMoved": return {ctor: "_Tuple2",_0: A3($Move.computer,_p0._0._0,_p0._0._1,taggedModel),_1: $Effects.none};
         case "ToggleDebug": return {ctor: "_Tuple2",_0: _U.update(taggedModel,{debugMode: $Basics.not(taggedModel.debugMode)}),_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(taggedModel,{seed: $Random.initialSeed($Basics.round($Time.inMilliseconds(_p0._0)))})
                         ,_1: $Effects.none};}
   });
   return _elm.Update.values = {_op: _op,update: update};
};
Elm.Views = Elm.Views || {};
Elm.Views.Board = Elm.Views.Board || {};
Elm.Views.Board.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.Board = _elm.Views.Board || {};
   if (_elm.Views.Board.values) return _elm.Views.Board.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Board = Elm.Board.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $ViewConstants = Elm.ViewConstants.make(_elm);
   var _op = {};
   var batsu = $Graphics$Collage.group(_U.list([A2($Graphics$Collage.traced,
                                               $ViewConstants.batsuLineStyle,
                                               A2($Graphics$Collage.segment,
                                               {ctor: "_Tuple2"
                                               ,_0: (0 - $ViewConstants.batsuFraction) * $ViewConstants.squareSize
                                               ,_1: (0 - $ViewConstants.batsuFraction) * $ViewConstants.squareSize},
                                               {ctor: "_Tuple2"
                                               ,_0: $ViewConstants.batsuFraction * $ViewConstants.squareSize
                                               ,_1: $ViewConstants.batsuFraction * $ViewConstants.squareSize}))
                                               ...
                                               ,_0: (0 - $ViewConstants.batsuFraction) * $ViewConstants.squareSize
                                               ,_1: $ViewConstants.batsuFraction * $ViewConstants.squareSize}))]));
   var maru = A2($Graphics$Collage.outlined,$ViewConstants.maruLineStyle,$Graphics$Collage.circle($ViewConstants.maruFraction * $ViewConstants.squareSize));
   var drawPiece = function (_p0) {
      var _p1 = _p0;
      var _p3 = _p1._0;
      var pic = function () {    var _p2 = _p1._1;if (_p2.ctor === "O") {    return maru;} else {    return batsu;}}();
      var yShift = $Basics.toFloat(((_p3 - 1) / 3 | 0) - 1) * $ViewConstants.squareSize;
      var xShift = $Basics.toFloat(A2($Basics._op["%"],_p3 - 1,3) - 1) * $ViewConstants.squareSize;
      return A2($Graphics$Collage.move,{ctor: "_Tuple2",_0: xShift,_1: 0 - yShift},pic);
   };
   var boardFrame = function () {
      var tr = $Graphics$Collage.traced($ViewConstants.gridLineStyle);
      return _U.list([tr(A2($Graphics$Collage.segment,
                     {ctor: "_Tuple2",_0: -1.5 * $ViewConstants.squareSize,_1: 0.5 * $ViewConstants.squareSize},
                     {ctor: "_Tuple2",_0: 1.5 * $ViewConstants.squareSize,_1: 0.5 * $ViewConstants.squareSize}))
                     ,tr(A2($Graphics$Collage.segment,
                     {ctor: "_Tuple2",_0: -1.5 * $ViewConstants.squareSize,_1: -0.5 * $ViewConstants.squareSize},
                     {ctor: "_Tuple2",_0: 1.5 * $ViewConstants.squareSize,_1: -0.5 * $ViewConstants.squareSize}))
                     ,tr(A2($Graphics$Collage.segment,
                     {ctor: "_Tuple2",_0: -0.5 * $ViewConstants.squareSize,_1: -1.5 * $ViewConstants.squareSize},
                     {ctor: "_Tuple2",_0: -0.5 * $ViewConstants.squareSize,_1: 1.5 * $ViewConstants.squareSize}))
                     ,tr(A2($Graphics$Collage.segment,
                     {ctor: "_Tuple2",_0: 0.5 * $ViewConstants.squareSize,_1: -1.5 * $ViewConstants.squareSize},
                     {ctor: "_Tuple2",_0: 0.5 * $ViewConstants.squareSize,_1: 1.5 * $ViewConstants.squareSize}))]);
   ...
   var view = function (board) {
      var size = $Basics.round(3.0 * $ViewConstants.squareSize);
      return $Html.fromElement(A3($Graphics$Collage.collage,size,size,A2($Basics._op["++"],boardFrame,A2($List.map,drawPiece,$Board.toList(board)))));
   };
   return _elm.Views.Board.values = {_op: _op,view: view};
};
Elm.Views = Elm.Views || {};
Elm.Views.Buttons = Elm.Views.Buttons || {};
Elm.Views.Buttons.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.Buttons = _elm.Views.Buttons || {};
   if (_elm.Views.Buttons.values) return _elm.Views.Buttons.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions = Elm.Actions.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var playButton = F3(function (address,action,label) {
      return A2($Html.button,_U.list([$Html$Attributes.$class("play-button"),A2($Html$Events.onClick,address,action)]),_U.list([$Html.text(label)]));
   });
   var view = function (address) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("play-button-box")]),
      _U.list([A3(playButton,address,$Actions.StartAsBatsu,"Start as X"),A3(playButton,address,$Actions.StartAsMaru,"Start as O")]));
   };
   return _elm.Views.Buttons.values = {_op: _op,view: view};
};
Elm.Views = Elm.Views || {};
Elm.Views.DebugBox = Elm.Views.DebugBox || {};
Elm.Views.DebugBox.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.DebugBox = _elm.Views.DebugBox || {};
   if (_elm.Views.DebugBox.values) return _elm.Views.DebugBox.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var view = function (_p0) {
      var _p1 = _p0;
      return A2($Html.div,_U.list([$Html$Attributes.$class("debug-box")]),_U.list([$Html.text(_p1._0 ? _p1._1 : "")]));
   };
   return _elm.Views.DebugBox.values = {_op: _op,view: view};
};
Elm.Views = Elm.Views || {};
Elm.Views.MessageBox = Elm.Views.MessageBox || {};
Elm.Views.MessageBox.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.MessageBox = _elm.Views.MessageBox || {};
   if (_elm.Views.MessageBox.values) return _elm.Views.MessageBox.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = function (message) {    return A2($Html.div,_U.list([$Html$Attributes.$class("message-box")]),_U.list([$Html.text(message)]));};
   return _elm.Views.MessageBox.values = {_op: _op,view: view};
};
Elm.Views = Elm.Views || {};
Elm.Views.View = Elm.Views.View || {};
Elm.Views.View.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.View = _elm.Views.View || {};
   if (_elm.Views.View.values) return _elm.Views.View.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Actions = Elm.Actions.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Views$Board = Elm.Views.Board.make(_elm),
   $Views$Buttons = Elm.Views.Buttons.make(_elm),
   $Views$DebugBox = Elm.Views.DebugBox.make(_elm),
   $Views$MessageBox = Elm.Views.MessageBox.make(_elm);
   var _op = {};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([$Views$Board.view(model.board)
              ,$Views$Buttons.view(address)
              ,$Views$MessageBox.view(model.message)
              ,$Views$DebugBox.view({ctor: "_Tuple2",_0: model.debugMode,_1: $Basics.toString(model)})]));
   });
   return _elm.Views.View.values = {_op: _op,view: view};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $KeyPresses = Elm.KeyPresses.make(_elm),
   $Keyboard = Elm.Keyboard.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Models = Elm.Models.make(_elm),
   $MouseClick = Elm.MouseClick.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp = Elm.StartApp.make(_elm),
   $Task = Elm.Task.make(_elm),
   $Update = Elm.Update.make(_elm),
   $Views$View = Elm.Views.View.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: $Models.initial
                             ,inputs: _U.list([$MouseClick.signal,A2($Signal.map,$KeyPresses.handler,$Keyboard.presses)])
